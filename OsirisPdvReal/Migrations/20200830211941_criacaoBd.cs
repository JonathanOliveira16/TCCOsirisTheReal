    ...
    public partial class criacaoBd : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    BancaId = table.Column<int>(nullable: false),
                    JornaleiroId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_JornaleiroBanca", x => new { x.BancaId, x.JornaleiroId });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Jornaleiros", x => x.JornaleiroId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JornaleiroId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Bancas", x => x.BancaId);
                    table.ForeignKey(
                        name: "FK_Bancas_Jornaleiros_JornaleiroId",
                        column: x => x.JornaleiroId,
                        principalTable: "Jornaleiros",
                        principalColumn: "JornaleiroId",
                        onDelete: ReferentialAction.Restrict);
                });
